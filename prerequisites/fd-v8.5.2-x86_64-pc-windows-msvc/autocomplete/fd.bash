_D:\a\fd\fd\target\release\fd.exe() {
    ...
    do
        case "${cmd},${i}" in
            ",$1")
                cmd="D:\a\fd\fd\target\release\fd.exe"
                ;;
            *)
                ;;
        esac
...
complete -F _D:\a\fd\fd\target\release\fd.exe -o bashdefault -o default D:\a\fd\fd\target\release\fd.exe
